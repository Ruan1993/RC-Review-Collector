  ...
  try {
    ...
    for (const docSnap of snapshot.docs) {
      ...
      if (!placeId) {
        ...
        console.warn(`[${docId}] Skipped: No placeId`);
        continue;
      }
      ...
      try {
        ...
        if (data.status !== 'OK') {
          console.error(`[${docId}] Google API Error: ${data.status}`, data);
        ...
        console.log(`[${docId}] Google API returned ${latestReviews.length} reviews`);
